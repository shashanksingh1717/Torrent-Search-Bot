...
DEFAULT_SEARCH_MARKUP = [
                    ...
                    [InlineKeyboardButton("Channel: homiesmovie", url="https://t.me/+DgBVT9VCbyU1MjZl")],
                   ]
...
async def start_handler(_, message: Message):
    try:
        await message.reply_text(
            text="ʜᴇʟʟᴏ,  ɪ ᴀᴍ ᴠᴇɴᴏᴍ ✘ ᴛᴏʀʀᴇɴᴛ ꜱᴇᴀʀᴄʜ ʙᴏᴛ!\n"

                 "ɪ ᴄᴀɴ ꜱᴇᴀʀᴄʜ ᴛᴏʀʀᴇɴᴛ ᴍᴀɢɴᴇᴛɪᴄ ʟɪɴᴋꜱ ꜰʀᴏᴍ ɪɴʟɪɴᴇ.\n\n"

                 "• ᴍᴀᴅᴇ ʙʏ :- @venomofwrite",
